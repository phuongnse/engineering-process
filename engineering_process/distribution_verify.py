...
REQUIRED_SUFFIXES = {
    ...
    "schemas/authority-transition-evidence.schema.json",
    "schemas/authority-transition-request.schema.json",
    ...
    "schemas/bootstrap-adoption-consumption.schema.json",
    "schemas/bootstrap-adoption-intent.schema.json",
    "examples/authority-transition-evidence.json",
    "examples/authority-transition-request.json",
    "examples/bootstrap-adoption-consumption.json",
    "examples/bootstrap-adoption-intent.json",
    ...
    "schemas/plan-decision-review-assignment.schema.json",
